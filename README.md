...
🚥 Getting Started
Launch LM Studio: Open LM Studio and start the Local Server (usually on port 1234).

Enable CORS: Ensure "Cross-Origin Resource Sharing" is enabled in your LM Studio settings to allow the web app to communicate with the server.

Clone & Open: Clone this repository and open index.html in any modern browser.

Connect: Open the Settings modal in EchoAI, detect your models, and start chatting!
